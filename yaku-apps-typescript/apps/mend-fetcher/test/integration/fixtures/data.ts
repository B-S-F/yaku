...
export const vulnerabilitiesFixSummaryData = [
  {
    vulnerability: 'vulnerability1-name',
    topRankedFix: {
      id: 123456,
      vulnerability: 'securityAlert1-topFixVulnerability',
      type: 'securityAlert1-topFixType',
  ...
  {
    vulnerability: 'vulnerability2-name',
    topRankedFix: {
      id: 456789,
      vulnerability: 'securityAlert3-topFixVulnerability',
      type: 'securityAlert3-topFixType',
      origin: 'securityAlert3-topFixOrigin',
      url: 'securityAlert3-topFixUrl',
      fixResolution: 'securityAlert3-topFixFixResolution',
      date: 'securityAlert3-topFixDate',
      message: 'securityAlert3-topFixMessage',
      extraData: {},
    },
    allFixes: [
      {
      ...
      {
        id: 567890,
        vulnerability: 'securityAlert4-topFixVulnerability',
        type: 'securityAlert4-topFixType',
        origin: 'securityAlert4-topFixOrigin',
        url: 'securityAlert4-topFixUrl',
        fixResolution: 'securityAlert4-topFixFixResolution',
        date: 'securityAlert4-topFixDate',
        message: 'securityAlert4-topFixMessage',
        extraData: {},
      },
    ],
    totalUpVotes: 12345,
